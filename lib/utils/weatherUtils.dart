...
String prepareHourlyWeather(String long, String lat) {
  var url =
      '$OPEN_WEATHER_4DAY_URL?lat=$lat&lon=$long&units=metric&appid=$OPEN_WEATHER_API_KEY';
  return url;
}
